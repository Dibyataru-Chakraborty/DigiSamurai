  ...
  return (
    <section className="py-16 bg-white flex flex-col items-center justify-center text-center">
      <div className="container mx-auto">
        ...
        <div className="lg:flex-row items-center justify-center lg:space-x-8">
              ...
              <div className="relative overflow-hidden rounded-lg shadow-lg">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                  ...
                  <p className="text-white text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 font-[Jura]">
                    Provide a comprehensive range of services across
                    cybersecurity and compliance domains. With expertise
                    spanning from advanced offensive to defensive security
                    measures, including penetration testing, secure
                    configuration reviews, and forensic investigations, helping
                    organizations navigate complex compliance requirements, such
                    as GDPR, PCI DSS, and various industry standards.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative overflow-hidden rounded-lg shadow-lg">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                  ...
                  <p className="text-white text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 font-[Jura]">
                    ...
                    skills that spark innovation and drive performance. In
                    today’s fast-paced world, staying ahead means constantly
                    evolving. Our training programs are designed to transform
                    employees into high-impact performers and position companies
                    as industry frontrunners. It’s not just about acquiring
                    knowledge—it’s about building a smarter, stronger, and more
                    agile workforce ready to lead the future.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative overflow-hidden rounded-lg shadow-lg">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                  ...
                  <p className="text-white text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 font-[Jura]">
                    ...
                    experience and skilled academics, we aim to improve
                    individual potential and organizational security.
                  </p>
                </div>
              </div>
            </div>
