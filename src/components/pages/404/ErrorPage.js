      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full px-4">
        ...
        >
          <h2 className="text-center text-xl md:text-4xl font-bold text-black dark:text-white">
            404: Page Breached or Not Found
          </h2>
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-md mt-2 mx-auto">
            The page you’re looking for doesn’t exist—or has gone dark. Our
            digital perimeter didn’t detect it. Try checking the URL or return
            safely to the homepage.
          </p>
        </motion.div>
