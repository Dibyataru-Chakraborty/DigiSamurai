  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col md:flex-row md:space-x-16 lg:border-l border-[#5a3f3f] pl-6">
            ...
            <div className="flex flex-col">
              ...
              <Link
                ...
                style={{ fontFamily: "Josefin Sans" }}
              >
                <i className="fas fa-envelope mr-1" /> connect@digisamurai.co.in
              </Link>
      ...
      <div className="mt-6 py-8 flex flex-col md:flex-row justify-between items-center text-[10px] text-[#a18484]">
        ...
        <div>Website Design: <Link className="hover:underline" href={"https://zerodayalliance.pages.dev/"}>ZeroDay Alliance</Link></div>
      </div>
    </section>
  );
}
