  ...
  return (
    <section ref={ref} className="pb-16 bg-white">
      <div className="container mx-auto px-8 py-16 lg:w-5/6">
        ...
        <p
          className="mt-6 xl:text-4xl text-xl mx-auto leading-relaxed font-[Jura] text-center bg-clip-text text-transparent"
          style={{
            backgroundImage:
              "linear-gradient(90deg,rgba(255, 0, 5, 1) 0%, rgba(0, 0, 0, 1) 100%)",
          }}
        >
          “Partner with us for tailored cybersecurity expertise, proactive
        ...
        <p className="mt-6 text-black xl:text-4xl text-xl mx-auto leading-relaxed font-[Jura] text-center">
          ...
          enhance your team’s capabili6es, and leverage the latest innova6ons to
          stay secure and competitive in an ever-evolving digital landscape
        </p>
        <p
          className="mt-8 bg-red-300 lg:text-4xl text-xl rounded-3xl lg:rounded-full px-8 py-4 mx-auto leading-relaxed font-[Jura] text-center"
          style={{ color: "#2A1111" }}
        >
          Our team combines extensive expertise, industry-leading resources, and
          top-tier cyber security certifications to deliver unparalleled
